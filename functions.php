...
/** ---------------------------------------------------------
 * Menu Headings - Convert links to spans for non-clickable headers
 * -------------------------------------------------------- */
add_filter('walker_nav_menu_start_el', function($item_output, $item, $depth, $args) {
	if (is_array($item->classes) && in_array('menu-heading', $item->classes, true)) {
		// Replace <a> with <span> and remove any href completely
		$item_output = preg_replace(
			'/<a[^>]*>(.*?)<\/a>/i',
			'<span class="menu-heading-text" role="presentation">$1</span>',
			$item_output
		);
	}
	return $item_output;
...
function e3_get_page_specific_hero_content( $post_id ) {
	...
	if ( 'fire-doors' === $slug ) {
		$page_content = array(
			...
			'top_bullet_3' => 'Fire Door Compliance Support',
			'title'        => 'Fire Doors [location]',
			'subtitle'     => 'Full Inspection • Repairs, Maintenance, and Installation Options • Transparent Pricing • We Check Closing, Latching, and Seals, Then Provide Clear Records for Your Fire Safety File',
			'usp_1_title'  => 'Survey and Advice',
			'usp_1_desc'   => 'We Inspect, Repair, and Maintain Fire Doors So They Self-Close, Latch, and Seal Correctly.',
			'usp_2_title'  => 'Written Quote Option',
			'usp_2_desc'   => 'We Focus On Doorset Performance: Gaps, Seals, Closers, Hinges, and Latching Hardware Set Up to Work Together.',
			'usp_3_title'  => 'Clear Remedial Notes',
			'usp_3_desc'   => 'We Provide a Written Quote and Clear Record Notes, Then Confirm Next Steps Before Any Work Starts.',
			'usp_4_title'  => 'DBS Checked',
			'usp_4_desc'   => 'DBS Checked, Fully Insured, With Work Guaranteed and Practical Records for Building Fire Safety Files.',
			'cta_text'     => 'Get Help With Fire Doors',
			'microcopy'    => 'Fire Door Support • Clear Pricing • DBS Checked',
			'badge_1'      => 'Survey and Advice',
			'badge_2'      => 'Written Quote Option',
			'badge_3'      => 'Clear Remedial Notes',
			'badge_4'      => 'DBS Checked',
			'sticky_cta'   => 'Call Now Fire Door Inspection',
		);
	}
	...
	if ( 'door-closers' === $slug ) {
		$page_content = array(
			...
			'usp_3_title'  => 'Expert Installation Standards',
			...
			'usp_4_title'  => 'All Closer Types [location]',
	...
	// Fire Door Repairs Page
	if ( 'fire-door-repair' === $slug || 'fire-door-repairs' === $slug || 'repairs' === $slug ) {
		$page_content = array(
			'top_label'    => 'Same-Day Service',
			'top_bullet_1' => 'No Call Out Fee',
			'top_bullet_2' => 'Upfront Quote Before Work',
			'top_bullet_3' => 'Fire Door Not Latching',
			'title'        => 'Fire Door Repairs [location]',
			'subtitle'     => 'Safety Priority • Fix Closers, Seals, Hinges, and Latching Faults • Upfront Quote Before Work • We Restore Proper Self-Closing and Provide Remedial Notes for Compliance',
			'usp_1_title'  => 'Same-Day Repairs',
			'usp_1_desc'   => 'We Repair Fire Doors So They Close Smoothly, Latch Reliably, and Protect Escape Routes.',
			'usp_2_title'  => 'Upfront Quote First',
			'usp_2_desc'   => 'We Align Keeps, Adjust or Replace Closers, and Fix Seals So the Door Seats Properly Without Slamming.',
			'usp_3_title'  => 'Closer and Latch Fix',
			'usp_3_desc'   => 'We Confirm the Quote Before Work and Explain Repair Vs Replacement When Needed.',
			'usp_4_title'  => 'DBS Checked',
			'usp_4_desc'   => 'Parts Carried for Common Fixes, With DBS Checked, Fully Insured Technicians and Remedial Notes Provided After Works.',
			'cta_text'     => 'Call Now for Fire Door Repairs',
			'microcopy'    => 'Compliance Repairs • Clear Pricing • DBS Checked',
			'badge_1'      => 'Same-Day Repairs',
			'badge_2'      => 'Upfront Quote First',
			'badge_3'      => 'Closer and Latch Fix',
			'badge_4'      => 'DBS Checked',
			'sticky_cta'   => 'Call Now Fire Door Repairs',
		);
	}
	...
	if ( 'intercom-system-repairs' === $slug || 'intercom-repairs' === $slug ) {
		$page_content = array(
			...
			'top_bullet_1' => 'No Call Out Fee',
			'top_bullet_2' => 'Upfront Quote Before Work',
			'top_bullet_3' => 'Intercom Not Releasing Door',
			'title'        => 'Intercom System Repairs [location]',
			'subtitle'     => 'Fast Repair • Fix Door Entry, Audio, and Release Faults • Upfront Quote Before Work • We Test Call and Release Cycles End-To-End for Reliable Access',
			'usp_1_title'  => 'Same-Day Fault Fix',
			'usp_1_desc'   => 'We Repair Intercom Systems So Calls Are Clear and Door Release Works When Needed.',
			'usp_2_title'  => 'Quote Confirmed First',
			'usp_2_desc'   => 'We Check Power, Wiring, and Release Hardware to Stop Intermittent Faults and Restore Reliable Entry.',
			'usp_3_title'  => 'Tested Before Handover',
			'usp_3_desc'   => 'We Explain Options and Confirm the Price Before Work, Including Any Parts Required.',
			'usp_4_title'  => 'DBS Checked',
			'usp_4_desc'   => 'DBS Checked, Fully Insured Local Technician Who Tests Calls, Audio, and Release Cycles End-To-End Before Handover.',
			'cta_text'     => 'Get Help With Intercom Repair',
			'microcopy'    => 'Door Entry Specialists • Clear Pricing • DBS Checked',
			'badge_1'      => 'Same-Day Fault Fix',
			'badge_2'      => 'Quote Confirmed First',
			'badge_3'      => 'Tested Before Handover',
			'badge_4'      => 'DBS Checked',
			'sticky_cta'   => 'Call Now Intercom Repair',
		);
	}

	// Garage Door Lock Repair Page
	if ( 'garage-door-lock-repair' === $slug ) {
		$page_content = array(
			'top_label'    => 'Same-Day Service',
			'top_bullet_1' => 'No Call Out Fee',
			'top_bullet_2' => 'Upfront Quote Before Work',
			'top_bullet_3' => 'Garage Lock Not Turning',
			'title'        => 'Garage Door Lock Repair [location]',
			'subtitle'     => 'Same-Day Visit • Restore Smooth Locking Without Forcing • Upfront Quote Before Work • Parts Carried to Stabilise Keeps and Bars, Then We Test Repeated Cycles',
			'usp_1_title'  => 'Same-Day Garage Repair',
			'usp_1_desc'   => 'We Repair or Replace Garage Locks So the Door Secures Reliably Every Time.',
			'usp_2_title'  => 'Upfront Quote First',
			'usp_2_desc'   => 'We Diagnose Lock and Alignment Issues, Using Damage-Free First Methods to Restore Smooth Key Turns Without Forcing or Slamming.',
			'usp_3_title'  => 'Damage-Free First',
			'usp_3_desc'   => 'We Confirm the Quote Before Work After Checking Door Type, Lock System, and Any Parts Needed.',
			'usp_4_title'  => 'DBS Checked',
			'usp_4_desc'   => 'Work Is Guaranteed, With DBS Checked, Fully Insured Local Technician and Parts Carried, Then Tested Through Multiple Lock and Unlock Cycles.',
			'cta_text'     => 'Call Now for Garage Repair',
			'microcopy'    => 'Garage Lock Specialists • Clear Pricing • DBS Checked',
			'badge_1'      => 'Same-Day Garage Repair',
			'badge_2'      => 'Upfront Quote First',
			'badge_3'      => 'Damage-Free First',
			'badge_4'      => 'DBS Checked',
			'sticky_cta'   => 'Call Now Garage Lock Repair',
		);
	}

	// Intercom Installation Page
	if ( 'intercom-installation' === $slug ) {
		$page_content = array(
			'top_label'    => 'Get a Quote Today',
			'top_bullet_1' => 'Transparent Pricing',
			'top_bullet_2' => 'Written Quote Available',
			'top_bullet_3' => 'New Door Entry Setup',
			'title'        => 'Intercom Installation [location]',
			'subtitle'     => 'Written Quote • Choose Audio or Video Options • Transparent Pricing • We Install, Configure, and Test Release Under Load So Entry Works Every Time',
			'usp_1_title'  => 'Quote Today',
			'usp_1_desc'   => 'We Specify and Install Intercom Systems That Give Clear Calling and Controlled Door Release.',
			'usp_2_title'  => 'Written Quote Option',
			'usp_2_desc'   => 'We Fit Cabling, Power, and Release Hardware Correctly, Then Commission the System With Repeated Call and Unlock Tests.',
			'usp_3_title'  => 'Neat Cable Routing',
			'usp_3_desc'   => 'You Receive a Written Quote With Options, Then We Confirm Scope, Access, and Timeline Before Installation.',
			'usp_4_title'  => 'DBS Checked',
			'usp_4_desc'   => 'Neat Workmanship From DBS Checked, Fully Insured Technicians, With Aftercare Advice and a Proper Handover Test.',
			'cta_text'     => 'Speak to a Locksmith Today',
			'microcopy'    => 'Audio or Video Options • Clear Pricing • DBS Checked',
			'badge_1'      => 'Quote Today',
			'badge_2'      => 'Written Quote Option',
			'badge_3'      => 'Neat Cable Routing',
			'badge_4'      => 'DBS Checked',
			'sticky_cta'   => 'Call Now Intercom Installation',
		);
	}

	// Fire Door Installation Page
	if ( 'fire-door-installation' === $slug || 'installation' === $slug ) {
		$page_content = array(
			'top_label'    => 'Get a Quote Today',
			'top_bullet_1' => 'Transparent Pricing',
			'top_bullet_2' => 'Written Quote Available',
			'top_bullet_3' => 'New Fire Doors Fitted',
			'title'        => 'Fire Door Installation [location]',
			'subtitle'     => 'Doorset Fitting • Specification-Led Installation • Transparent Pricing • We Install Leaf, Frame, Seals, and Hardware, Then Commission Closing and Latching for Day-To-Day Use',
			'usp_1_title'  => 'Booked Install Slot',
			'usp_1_desc'   => 'We Install Fire-Rated Doorsets to Suit the Opening, With Correct Fit, Seals, and Hardware.',
			'usp_2_title'  => 'Written Quote Option',
			'usp_2_desc'   => 'We Fit Compatible Closers, Hinges, and Latches So the Door Self-Closes Under Control and Latches Reliably.',
			'usp_3_title'  => 'Neat Finish',
			'usp_3_desc'   => 'We Survey, Quote, and Confirm Specification Before Work, Including Doorset, Frame, and Ironmongery Requirements.',
			'usp_4_title'  => 'DBS Checked',
			'usp_4_desc'   => 'Commissioning Checks Included, With Neat Finish, DBS Checked Technicians, and Handover Notes for Your Records.',
			'cta_text'     => 'Speak to a Locksmith for Installation',
			'microcopy'    => 'Doorset Installation • Clear Pricing • DBS Checked',
			'badge_1'      => 'Booked Install Slot',
			'badge_2'      => 'Written Quote Option',
			'badge_3'      => 'Neat Finish',
			'badge_4'      => 'DBS Checked',
			'sticky_cta'   => 'Call Now Fire Door Installation',
		);
	}

	// Fire Door Maintenance Page
	if ( 'fire-door-maintenance' === $slug || 'maintenance' === $slug ) {
		$page_content = array(
			'top_label'    => 'Get a Quote Today',
			'top_bullet_1' => 'Transparent Pricing',
			'top_bullet_2' => 'Written Quote Available',
			'top_bullet_3' => 'Routine Fire Door Checks',
			'title'        => 'Fire Door Maintenance [location]',
			'subtitle'     => 'Routine Visits • Prioritised Defect Reporting • Transparent Pricing • We Log Findings by Door, Then Plan Repairs or Replacement to Keep Records Simple',
			'usp_1_title'  => 'Scheduled Visits',
			'usp_1_desc'   => 'We Maintain Fire Doors With Routine Checks So Closing and Latching Stay Reliable in Daily Use.',
			'usp_2_title'  => 'Clear Reporting',
			'usp_2_desc'   => 'We Inspect Closers, Hinges, Seals, Gaps, and Ironmongery, Then Record Defects With Clear Priorities.',
			'usp_3_title'  => 'Prioritised Actions',
			'usp_3_desc'   => 'You Get a Written Report With Actions and a Quote for Remedial Works Before Booking.',
			'usp_4_title'  => 'DBS Checked',
			'usp_4_desc'   => 'Ideal for Blocks and Managed Sites, With DBS Checked, Fully Insured Technicians and Neat Workmanship.',
			'cta_text'     => 'Get Help With Maintenance Visits',
			'microcopy'    => 'Routine Checks • Clear Pricing • DBS Checked',
			'badge_1'      => 'Scheduled Visits',
			'badge_2'      => 'Clear Reporting',
			'badge_3'      => 'Prioritised Actions',
			'badge_4'      => 'DBS Checked',
			'sticky_cta'   => 'Call Now Fire Door Maintenance',
		);
	}

	// Fire Door Replacement Page
	if ( 'fire-door-replacement' === $slug || 'replacement' === $slug ) {
		$page_content = array(
			'top_label'    => 'Get a Quote Today',
			'top_bullet_1' => 'Transparent Pricing',
			'top_bullet_2' => 'Written Quote Available',
			'top_bullet_3' => 'Fire Door Needs Replacing',
			'title'        => 'Fire Door Replacement [location]',
			'subtitle'     => 'Replacement Plan • Doorset-Level Options • Transparent Pricing • We Assess Whether Repair Is Viable, Then Replace With Compatible Seals, Closers, and Hardware',
			'usp_1_title'  => 'Survey Then Replace',
			'usp_1_desc'   => 'We Replace Fire Doors Where Repair Cannot Restore Reliable Self-Closing, Latching, and Sealing.',
			'usp_2_title'  => 'Written Quote Option',
			'usp_2_desc'   => 'We Specify a Complete Doorset So the Leaf, Frame, Seals, Closer, and Latching Hardware Work Together.',
			'usp_3_title'  => 'Correct Hardware Set',
			'usp_3_desc'   => 'We Provide a Written Quote After Surveying Each Opening, Then Confirm Scope, Access, and Lead Times Before Works.',
			'usp_4_title'  => 'DBS Checked',
			'usp_4_desc'   => 'Fully Insured, DBS Checked Technicians, With Neat Fit, Correct Hardware, and Clear Handover Records.',
			'cta_text'     => 'Get Help With Fire Door Replacement',
			'microcopy'    => 'Replacement Options • Clear Pricing • DBS Checked',
			'badge_1'      => 'Survey Then Replace',
			'badge_2'      => 'Written Quote Option',
			'badge_3'      => 'Correct Hardware Set',
			'badge_4'      => 'DBS Checked',
			'sticky_cta'   => 'Call Now Fire Door Replacement',
		);
	}
